...
| Does buying the SAME coin twice add risk? | **YES, and it is the single cleanest result in the project.** A second fill is the SAME bet, not a second one, so the question is whether markets offering a cheaper second price go bad. **25 of 349 markets whose price fell >=0.5c went bad (7.16%). 0 of 843 whose price did not (0.00%).** Every bad outcome in the population came from a falling price. Contaminated -- a market settling against us is WHY its price falls -- but that contamination IS the mechanism: you only get the cheaper second price when the market is turning against you. The contract cap equalises the DOLLARS (same expected loss, $2.87) but losing everything at once is 24% more likely on one coin than split across two. | this file |
| Are there hourly series worth trading? | **15 of 71 settle on an AVERAGE** -- KXBTC/KXBTCD, KXETH/KXETHD, KXSOL*, KXXRP*, KXDOGE*, KXBNB*, KXHYPE*, KXDJI. Same mechanism as our 15-minute markets, untested, and 4 (gold, silver, WTI, palladium hourly) are single-price and dead to us. 40 never ran a market. **The 15 are the best untested lead in the project.** | this file |
