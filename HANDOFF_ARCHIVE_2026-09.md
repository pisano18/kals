# HANDOFF ARCHIVE, 2026-09 -- older HANDOFF.md sections, verbatim, newest first

Moved out of `HANDOFF.md` on 2026-09-25 ~07Z to cut the cost of reading it (HANDOFF.md was 417 KB). Nothing here was edited. Append-only: when more sections leave HANDOFF.md, insert them directly below this header so the file stays newest first. Current state is `CURRENT_STATE.md` and the top of `HANDOFF.md`; statements below were true when written and many are superseded (check `results/VERSIONS.md` for what is live).
